    ...
    def __qb_listener(self):
        try:
            ...
            if tor_info.state == "metaDL":
                ...
                self.__stalled_time = time()
                if not self.__dupChecked and STOP_DUPLICATE and ospath.isdir(f'{self.__path}') and not self.__listener.isLeech and not self.select:                    LOGGER.info('Checking File/Folder if already in Drive')
