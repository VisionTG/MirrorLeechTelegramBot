...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipMirrorCommand = f'extract_irror{CMD_INDEX}'
        ...
        self.QbUnzipMirrorCommand = f'qb_extract_mirror{CMD_INDEX}'
        self.QbZipMirrorCommand = f'qb_archive_mirror{CMD_INDEX}'
        ...
        self.QbUnzipLeechCommand = f'extract_leech{CMD_INDEX}'
        self.QbZipLeechCommand = f'qb_leech{CMD_INDEX}'
        self.LeechWatchCommand = f'yt_leech{CMD_INDEX}'
        self.LeechZipWatchCommand = f'yt_zip_leech{CMD_INDEX}'
        self.QbSelectCommand = f'qb_select{CMD_INDEX}'
